...
class Grafica2Pages extends StatefulWidget {
  static const String routename = 'Grafica2 de datos ';

  const Grafica2Pages({Key? key}) : super(key: key);

  @override
  State<Grafica2Pages> createState() => _Grafica2PagesState();
}

class _Grafica2PagesState extends State<Grafica2Pages> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Gráfica2 de datos"),
        leading: IconButton(
